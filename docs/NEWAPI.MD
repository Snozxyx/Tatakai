...
JavaScript Example
const res = await fetch('http://api.tatakai.me/api/v1/hianime/home');
...
async function getAnimeInfo(id) {
  const response = await fetch(`http://api.tatakai.me/api/v1/hianime/info/${id}`);
...
def get_trending():
    url = "http://api.tatakai.me/api/v1/hianime/home"
    response = requests.get(url)
    return response.json()

PHP (cURL)
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://api.tatakai.me/api/v1/hianime/home");
...
Method: GET
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/hianime/home"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/hianime/episode/sources?animeEpisodeId=one-piece-100?ep=107149"
...
Method: GET
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anikai/home"
...
q: Search keyword
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anikai/search?q=one+piece"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anikai/watch/one-piece-37?ep=1"
...
🧪 Test Command
curl -s "http://api.tatakai.me/api/v1/animeya/home"
...
🧪 Test Command
curl -s "http://api.tatakai.me/api/v1/animeya/search?q=one+piece"
...
🧪 Test Command
curl -s "http://api.tatakai.me/api/v1/animeya/info/one-piece-21"
...
🧪 Test Command
curl -s "http://api.tatakai.me/api/v1/animeya/watch/16428"
...
const client = new TatakaClient({
  baseUrl: "http://api.tatakai.me/api/v1" // Optional, defaults to localhost:4000
});
...
Method: GET
🧪 Example Request
curl -X GET "http://api.tatakai.me/api/v1/animelok/home"
...
curl -X GET "http://api.tatakai.me/api/v1/animelok/watch/naruto-shippuden-112233?ep=1"
...
episodeUrl: Full URL
🧪 Test Module
```bash curl -X GET "http://api.tatakai.me/api/v1/watchaw/episode?id=naruto-shippuden-1x1" ```
...
Method: GET
🧪 Test Module
```bash curl -X GET "http://api.tatakai.me/api/v1/hindidubbed/category/hindi-anime-movies" ```
...
Query Params: title
🧪 Test Module
```bash curl -X GET "http://api.tatakai.me/api/v1/hindidubbed/search?title=doraemon" ```
...
Method: GET
🧪 Test Module
```bash curl -X GET "http://api.tatakai.me/api/v1/hindidubbed/anime/doraemon-movie" ```
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime-api/quotes/random?anime=Naruto"
...
Method: GET
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime-api/facts/naruto"
...
Body: { "imageUrl": "..." }
🧪 Test Module
curl -X POST "http://api.tatakai.me/api/v1/anime-api/trace" \
...
Method: GET
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime-api/images/neko"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime-api/waifu?tags=maid"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime/gogoanime/naruto"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime/chia-anime/bleach"
...
Response: Array of { title, link, img }
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime/anime-freak/one%20piece"
...
🧪 Test Module
curl -X GET "http://api.tatakai.me/api/v1/anime/animeland/dragon%20ball"
