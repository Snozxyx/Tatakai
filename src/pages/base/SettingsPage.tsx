...
const FALLBACK_CHANGELOG = [
  {
    ...
    date: '2026-04-08',
    changes: [
      'V5 Release: Replaced legacy V4 announcement flow with the V5 release banner and rollout messaging',
      ...
      'Integrations: MAL and AniList sync now map titles more reliably and import lists more accurately',
      'Watch2Together: Added reconnect recovery, host transfer controls, synced countdown start, and chat export support',
      'Search & Discovery: Added cleaner anime/character search filters and improved screenshot matching controls',
      'Recommendations: Added explainability cards and user feedback persistence for recommendation quality tuning',
      'Security & Ops: Strengthened auth/proxy handling, hardened headers, and expanded CI quality gates (lint/type/test)',
    ],
  },
  {
    version: '4.1.20',
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0 overflow-hidden bg-background/95 backdrop-blur-xl border-border/50">
          <DialogHeader className="p-6 pb-2">
            ...
            <DialogDescription className="text-muted-foreground pt-1">
              Select the anime you want to import. Matching is ID-first, and you can manually choose a different Tatakai match for any row.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="px-6 py-2">
            <div className={cn(
              ...
              <p>
                <strong>ID Identification Notice</strong>: Imports are ID-first only. We use <code>{importSource === 'mal' ? 'mal_id' : 'anilist_id'}</code> / <code>mal_id</code> mappings directly and avoid automatic title guesses. Use <strong>Manual Match</strong> to override any item.
              </p>
            </div>
          </div>
