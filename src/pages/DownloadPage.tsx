                  ...
                  <div className="space-y-4 mb-8">
                    <div className="grid grid-cols-3 gap-px bg-gray-800 p-px rounded-md overflow-hidden">
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 py-3 text-[10px] font-bold uppercase tracking-wide transition-all ${selectedOS === 'mac' ? 'bg-white text-black' : 'bg-black text-gray-500 hover:text-white'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 py-3 text-[10px] font-bold uppercase tracking-wide transition-all ${selectedOS === 'win' ? 'bg-white text-black' : 'bg-black text-gray-500 hover:text-white'
                          }`}
                      >
